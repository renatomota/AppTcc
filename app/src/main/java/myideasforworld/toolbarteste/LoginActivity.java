...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Id to idenrity READ_CONTACTS permission request.
     */
    private static final int REQUEST_READ_CONTACTS = 0;

    /**
     * A dyDO: remove after connecting to a real authentication system.
     */
    ...
    private void attemptLogin() {
        ...
        } else if (isEmailValid(email)&& TextUtils.isEmpty(password)){
